...
- **EL METABOLISMO Y LAS CONDICIONES EXTERNAS, y es lo primero de la lista** (2026-08-25):
  §8, COA-38/39/40. Qué mirar, en un gesto solo: `coagulant_status` imprime las **tres capas
