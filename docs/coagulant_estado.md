...
3. **Enmienda §17 (2026-08-08b) — también SIN una línea de código**, y es lo que la hace fácil de confundir con avance: `sat`, `Perfusion`, la niebla y las condiciones ambientales **no existen** en el `lua/`. Lo que existe es el permiso de COA-28 para bajarlas. **No dar por sentado el orden**: la niebla depende del dolor como stat, que hoy sigue diferido por §1 — bajarla antes deja la silueta sin qué pintar.
